...
python scripts/run_pipeline.py --method single_model --use_wandb --input_file /home/lisabdunlap/LMM-Vibes/data/medhelm/aci_bench_results.jsonl --output_dir results/aci_bench --min_cluster_size 15 --run_metrics
