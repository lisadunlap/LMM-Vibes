...
python scripts/run_pipeline.py --method single_model --use_wandb --input_file data/self_instruct/self_instruct_results_oai_format.jsonl --output_dir results/self_instruct --min_cluster_size 30 --run_metrics
...
python scripts/run_pipeline.py --method single_model --use_wandb --input_file data/medhelm/aci_bench_results_oai_format.jsonl --output_dir results/aci_bench --min_cluster_size 30 --run_metrics
python scripts/run_pipeline.py --method single_model --use_wandb --input_file data/helm/helm_bigcodebench_results_processed_oai_biggest_models.jsonl --output_dir results/bigcodebench_biggest_models --min_cluster_size 30 --run_metrics

python scripts/run_pipeline.py --method single_model --use_wandb --input_file data/taubench/retail_data_oai_format.jsonl --output_dir results/taubench_retail --system_prompt agent_system_prompt --run_metrics
python scripts/run_pipeline.py --method single_model --use_wandb --input_file data/taubench/airline_data_oai_format.jsonl --output_dir results/taubench_airline --system_prompt agent_system_prompt --run_metrics
